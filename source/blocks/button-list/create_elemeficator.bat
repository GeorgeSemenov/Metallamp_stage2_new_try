...
(
echo include %filename%/button-list%filename%.pug
)> newFile.pug
type button-list.pug >> newFile.pug
move /Y newFile.pug  button-list.pug
(
...
(
echo @import '%fileName%/button-list%fileName%';
)>>button-list.scss
cd %fileName%
(
...
(
echo @echo off
echo set grandParentName=button-list
echo set parentName=%fileName%
echo set /p fileName=What would you create?
echo set newStyleSCSS=button-list%fileName%.scss
echo mkdir %%fileName%%
echo ^(
echo echo @import '%%fileName%%/button-list%fileName%%%fileName%%';
echo ^)^>^>%%newStyleSCSS%%
echo cd %%fileName%%
echo ^(
