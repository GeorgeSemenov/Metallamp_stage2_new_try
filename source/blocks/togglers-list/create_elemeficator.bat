...
(
echo include %filename%/togglers-list%filename%.pug
)> newFile.pug
type togglers-list.pug >> newFile.pug
move /Y newFile.pug  togglers-list.pug
(
...
(
echo @import '%fileName%/togglers-list%fileName%';
)>>togglers-list.scss
cd %fileName%
(
...
(
echo @echo off
echo set grandParentName=togglers-list
echo set parentName=%fileName%
echo set /p fileName=What would you create?
echo set newStyleSCSS=togglers-list%fileName%.scss
echo mkdir %%fileName%%
echo ^(
echo echo @import '%%fileName%%/togglers-list%fileName%%%fileName%%';
echo ^)^>^>%%newStyleSCSS%%
echo cd %%fileName%%
echo ^(
