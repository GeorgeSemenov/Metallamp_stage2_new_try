@echo off
set parentName=optional-inp-drop-title-and-desc-wrapper
...
(
echo include %filename%/optional-inp-drop-title-and-desc-wrapper%filename%.pug
)> newFile.pug
type optional-inp-drop-title-and-desc-wrapper.pug >> newFile.pug
move /Y newFile.pug  optional-inp-drop-title-and-desc-wrapper.pug
(
...
(
echo @import '%fileName%/optional-inp-drop-title-and-desc-wrapper%fileName%';
)>>optional-inp-drop-title-and-desc-wrapper.scss
cd %fileName%
(
...
(
echo @echo off
echo set grandParentName=optional-inp-drop-title-and-desc-wrapper
echo set parentName=%fileName%
echo set /p fileName=What would you create?
echo set newStyleSCSS=optional-inp-drop-title-and-desc-wrapper%fileName%.scss
echo mkdir %%fileName%%
echo ^(
echo echo @import '%%fileName%%/optional-inp-drop-title-and-desc-wrapper%fileName%%%fileName%%';
echo ^)^>^>%%newStyleSCSS%%
echo cd %%fileName%%
echo ^(
