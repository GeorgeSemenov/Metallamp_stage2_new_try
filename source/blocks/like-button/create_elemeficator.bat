...
(
echo include %filename%/like-button%filename%.pug
)> newFile.pug
type like-button.pug >> newFile.pug
move /Y newFile.pug  like-button.pug
(
...
(
echo @import '%fileName%/like-button%fileName%';
)>>like-button.scss
cd %fileName%
(
...
(
echo @echo off
echo set grandParentName=like-button
echo set parentName=%fileName%
echo set /p fileName=What would you create?
echo set newStyleSCSS=like-button%fileName%.scss
echo mkdir %%fileName%%
echo ^(
echo echo @import '%%fileName%%/like-button%fileName%%%fileName%%';
echo ^)^>^>%%newStyleSCSS%%
echo cd %%fileName%%
echo ^(
