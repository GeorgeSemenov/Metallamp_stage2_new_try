...
(
echo include %filename%/rate-button%filename%.pug
)> newFile.pug
type rate-button.pug >> newFile.pug
move /Y newFile.pug  rate-button.pug
(
...
(
echo @import '%fileName%/rate-button%fileName%';
)>>rate-button.scss
cd %fileName%
(
...
(
echo @echo off
echo set grandParentName=rate-button
echo set parentName=%fileName%
echo set /p fileName=What would you create?
echo set newStyleSCSS=rate-button%fileName%.scss
echo mkdir %%fileName%%
echo ^(
echo echo @import '%%fileName%%/rate-button%fileName%%%fileName%%';
echo ^)^>^>%%newStyleSCSS%%
echo cd %%fileName%%
echo ^(
