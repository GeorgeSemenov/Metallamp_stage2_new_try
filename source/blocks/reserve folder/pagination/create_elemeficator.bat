...
(
echo include %filename%/pagination%filename%.pug
)> newFile.pug
type pagination.pug >> newFile.pug
move /Y newFile.pug  pagination.pug
(
...
(
echo @import '%fileName%/pagination%fileName%';
)>>pagination.scss
cd %fileName%
(
...
(
echo @echo off
echo set grandParentName=pagination
echo set parentName=%fileName%
echo set /p fileName=What would you create?
echo set newStyleSCSS=pagination%fileName%.scss
echo mkdir %%fileName%%
echo ^(
echo echo @import '%%fileName%%/pagination%fileName%%%fileName%%';
echo ^)^>^>%%newStyleSCSS%%
echo cd %%fileName%%
echo ^(
