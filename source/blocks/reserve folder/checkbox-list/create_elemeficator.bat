...
(
echo include %filename%/checkbox-list%filename%.pug
)> newFile.pug
type checkbox-list.pug >> newFile.pug
move /Y newFile.pug  checkbox-list.pug
(
...
(
echo @import '%fileName%/checkbox-list%fileName%';
)>>checkbox-list.scss
cd %fileName%
(
...
(
echo @echo off
echo set grandParentName=checkbox-list
echo set parentName=%fileName%
echo set /p fileName=What would you create?
echo set newStyleSCSS=checkbox-list%fileName%.scss
echo mkdir %%fileName%%
echo ^(
echo echo @import '%%fileName%%/checkbox-list%fileName%%%fileName%%';
echo ^)^>^>%%newStyleSCSS%%
echo cd %%fileName%%
echo ^(
