@echo off
set parentName=like-button-list
...
(
echo include %filename%/like-button-list%filename%.pug
)> newFile.pug
type like-button-list.pug >> newFile.pug
move /Y newFile.pug  like-button-list.pug
(
...
(
echo @import '%fileName%/like-button-list%fileName%';
)>>like-button-list.scss
cd %fileName%
(
...
(
echo @echo off
echo set grandParentName=like-button-list
echo set parentName=%fileName%
echo set /p fileName=What would you create?
echo set newStyleSCSS=like-button-list%fileName%.scss
echo mkdir %%fileName%%
echo ^(
echo echo @import '%%fileName%%/like-button-list%fileName%%%fileName%%';
echo ^)^>^>%%newStyleSCSS%%
echo cd %%fileName%%
echo ^(
