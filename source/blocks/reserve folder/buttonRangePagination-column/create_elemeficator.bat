@echo off
set parentName=buttonRangePagination-column
...
(
echo include %filename%/buttonRangePagination-column%filename%.pug
)> newFile.pug
type buttonRangePagination-column.pug >> newFile.pug
move /Y newFile.pug  buttonRangePagination-column.pug
(
...
(
echo @import '%fileName%/buttonRangePagination-column%fileName%';
)>>buttonRangePagination-column.scss
cd %fileName%
(
...
(
echo @echo off
echo set grandParentName=buttonRangePagination-column
echo set parentName=%fileName%
echo set /p fileName=What would you create?
echo set newStyleSCSS=buttonRangePagination-column%fileName%.scss
echo mkdir %%fileName%%
echo ^(
echo echo @import '%%fileName%%/buttonRangePagination-column%fileName%%%fileName%%';
echo ^)^>^>%%newStyleSCSS%%
echo cd %%fileName%%
echo ^(
