...
(
echo include %filename%/text-field%filename%.pug
)> newFile.pug
type text-field.pug >> newFile.pug
move /Y newFile.pug  text-field.pug
(
...
(
echo @import '%fileName%/text-field%fileName%';
)>>text-field.scss
cd %fileName%
(
...
(
echo @echo off
echo set grandParentName=text-field
echo set parentName=%fileName%
echo set /p fileName=What would you create?
echo set newStyleSCSS=text-field%fileName%.scss
echo mkdir %%fileName%%
echo ^(
echo echo @import '%%fileName%%/text-field%fileName%%%fileName%%';
echo ^)^>^>%%newStyleSCSS%%
echo cd %%fileName%%
echo ^(
