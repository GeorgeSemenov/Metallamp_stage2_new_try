@echo off
set parentName=form-and-elements
...
(
echo include %filename%/form-and-elements%filename%.pug
)> newFile.pug
type form-and-elements.pug >> newFile.pug
move /Y newFile.pug  form-and-elements.pug
(
...
(
echo @import '%fileName%/form-and-elements%fileName%';
)>>form-and-elements.scss
cd %fileName%
(
...
(
echo @echo off
echo set grandParentName=form-and-elements
echo set parentName=%fileName%
echo set /p fileName=What would you create?
echo set newStyleSCSS=form-and-elements%fileName%.scss
echo mkdir %%fileName%%
echo ^(
echo echo @import '%%fileName%%/form-and-elements%fileName%%%fileName%%';
echo ^)^>^>%%newStyleSCSS%%
echo cd %%fileName%%
echo ^(
