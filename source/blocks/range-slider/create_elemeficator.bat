...
(
echo include %filename%/range-slider%filename%.pug
)> newFile.pug
type range-slider.pug >> newFile.pug
move /Y newFile.pug  range-slider.pug
(
...
(
echo @import '%fileName%/range-slider%fileName%';
)>>range-slider.scss
cd %fileName%
(
...
(
echo @echo off
echo set grandParentName=range-slider
echo set parentName=%fileName%
echo set /p fileName=What would you create?
echo set newStyleSCSS=range-slider%fileName%.scss
echo mkdir %%fileName%%
echo ^(
echo echo @import '%%fileName%%/range-slider%fileName%%%fileName%%';
echo ^)^>^>%%newStyleSCSS%%
echo cd %%fileName%%
echo ^(
